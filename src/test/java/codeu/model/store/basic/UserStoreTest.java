...
public class UserStoreTest {
  ...
  private final User USER_ONE =
      new User(UUID.randomUUID(), "test_username_one", "password one", "bio_one", Instant.ofEpochMilli(1000));
  private final User USER_TWO =
      new User(UUID.randomUUID(), "test_username_two", "password two", "bio_two", Instant.ofEpochMilli(2000));
  private final User USER_THREE =
      new User(UUID.randomUUID(), "test_username_three", "password three", "bio_three", Instant.ofEpochMilli(3000));
  ...
  public void testAddUser() {
    User inputUser = new User(UUID.randomUUID(), "test_username", "password", "Test bio", Instant.now());
